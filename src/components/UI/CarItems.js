...
export const CarItems = () => {
  ...
  return (
    <Row>
              ...
              <Col lg='4' md='6' sm='12' className='mb-5' key={vehicle.VEHICLE_ID}>
                <div className="card_item" >
                  ...
                  <div className="card_item_detail">
                    ...
                    <button className='item_btn book_card_btn' onClick={() => handleCardClick(vehicle)}> Book</button>
                  </div>
                </div>
              </Col>
            )
      ...
      {!showAll && (
        <Col>
          <button onClick={handleViewMoreClick} className="item_btn book_card_btn">
            View More
          </button>
        </Col>
      )}
